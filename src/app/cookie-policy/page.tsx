        ...
        <main className="relative min-h-screen">
            ...
            <section className="py-24 max-w-4xl mx-auto px-6 text-muted leading-relaxed space-y-8">
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <h2 className="text-2xl font-serif text-white">What are Cookies?</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">How We Use Cookies</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">Types of Cookies Used</h2>
                    ...
                    <h2 className="text-2xl font-serif text-white">Managing Cookies</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">Updates to this Policy</h2>
                    <p>
