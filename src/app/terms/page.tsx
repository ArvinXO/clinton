        ...
        <main className="relative min-h-screen">
            ...
            <section className="py-24 max-w-4xl mx-auto px-6 text-muted leading-relaxed space-y-8">
                ...
                >
                    ...
                    <h2 className="text-2xl font-serif text-white">2. Our Services</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">3. Use of Website</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">4. Case Assessment</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">6. Changes to Terms</h2>
                    <p>
