        ...
        <main className="relative min-h-screen">
            ...
            <section className="py-24 max-w-4xl mx-auto px-6 text-muted leading-relaxed space-y-8">
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <h2 className="text-2xl font-serif text-white">Our Commitment</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">How to Make a Complaint</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">Our Response Process</h2>
                    ...
                    <h2 className="text-2xl font-serif text-white">Further Action</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-serif text-white">Regulated Partners</h2>
                    <p>
